...
(async ()=>{
    ...
    /**   P.all()  **/ // console.log(await P.all([ promise1, promise2, promise3 ]));
    /**   P.props()  **/ // console.log(await P.props({ promise1, promise2, promise3 }));
    /**   P.each()  **/ // log.yellow(
    ...
    //         ]) 
    // )
    /**   P.some()  **/ log.yellow(// filter only alphabetic characters
    await P.some([
        P.echo('first', 4000),
        P.echo('second', 400),
        P.echo('third', 3000),
